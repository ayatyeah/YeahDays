 ...
 * прогоняем всё через Whisper и ищем в тексте слово, близкое к «салемай»
 * (нечёткое сравнение, Levenshtein), либо «salemai» латиницей.
 *
 ...
 * гораздо надёжнее распознаётся коротким отдельным произнесением.
 *
 ...
 * jarvis" и физически не отличит "СалемАй" от шума; своя модель для нового
...
export async function startVoiceLoop(): Promise<void> {
  ...
  log('СалемАй запущена. Слушаю через Whisper, скажи "СалемАй" в любой фразе.');
