...
export default function OfflinePage() {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center px-8 text-center">
      <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-3xl surface text-3xl">
        ✳
      </div>
      ...
      <a
        href="/app"
        className="press mt-6 flex h-11 items-center rounded-2xl bg-[var(--color-fg)] px-5 text-[14px] font-semibold text-[var(--color-bg)]"
      >
        К приложению
      </a>
    </div>
