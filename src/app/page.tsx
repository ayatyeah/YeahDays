...
const NUMBERS = [
  ...
  { k: "0 ₸", t: "стоимость", d: "Бесплатно, аккаунт за минуту" },
];
...
const FEATURES = [
  ...
  },
  {
    ...
    text: "Утро и вечер по твоему часовому поясу — час подстраивается под то, когда ты реально закрываешь дела, а закрыл норму — не потревожим. Плюс отдельные напоминания по задаче со временем и по ходу того, что сейчас в работе.",
  },
  {
    icon: "📱",
  ...
  },
  {
    ...
    text: "Пять характеристик — сила, интеллект, капитал, стабильность, здоровье — качаются от того, что ты реально закрываешь. Прогресс видно, а не только в цифрах на экране.",
  },
];
...
const FAQ = [
  {
    q: "Это платно?",
    a: "Нет, полностью бесплатно. Нужен только аккаунт — email и пароль, либо вход через Google.",
  },
  {
    q: "Зачем аккаунт?",
    a: "Чтобы прогресс жил на всех устройствах и не пропал при очистке браузера — регистрация занимает минуту.",
  },
  {
        ...
        >
          <Reveal>
            ...
            <p className="mt-6 max-w-2xl text-[16px] leading-relaxed text-[var(--color-fg-dim)]">
              ...
              159 полезных действий и каждый день собирает из них небольшую
