      ...
      {show && (
        ...
        >
          <div className="mx-auto flex max-w-2xl flex-col gap-3 rounded-2xl border border-[var(--color-border-strong)] bg-[var(--color-surface)] px-4 py-3.5 sm:flex-row sm:items-center sm:gap-4">
            <p className="flex-1 text-[12.5px] leading-snug text-[var(--color-fg-dim)]">
            ...
            <button
              onClick={accept}
              className="press h-10 shrink-0 rounded-xl bg-[var(--color-fg)] px-5 text-[13.5px] font-bold text-[var(--color-bg)]"
            >
              Принять
            </button>
          </div>
