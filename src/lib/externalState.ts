 ...
 * действуют от имени пользователя без браузерного стора — ассистент-канал
 * (/api/assistant) и внешние интеграции (/api/integrations/*).
 *
 ...
 * Node-рантайме нет. Локальные копии форм — тот же приём, что уже был в
 * /api/assistant до выноса сюда.
 */
